...
| Images | `public/images/` + `src/data/wuthering-waves.ts` | Own licensed / provided assets only |
...
4. Replace images; update **`wuthering-waves.ts`** (image registry) paths/alts
