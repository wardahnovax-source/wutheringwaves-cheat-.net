...
const assetsDir =
	'C:/Users/Aman/.cursor/projects/c-Users-Aman-wuthering-waveshacks/assets';
...
const USER_SCREENSHOTS = [
	{
		...
		file: 'wuthering-waves-esp-player-tags.webp',
	},
	{
		source:
		...
		file: 'wuthering-waves-wallhack-skeleton.webp',
	},
	{
		source:
		...
		file: 'wuthering-waves-aimbot-sniper.webp',
	},
	{
		source:
		...
		file: 'wuthering-waves-aimbot-skeleton.webp',
	},
	{
		source:
		...
		file: 'wuthering-waves-esp-radar.webp',
	},
	{
		source:
		...
		file: 'wuthering-waves-cheats-combat.webp',
	},
];
...
const REMOVE_PREFIXES = [
	'wuthering-waves-battle-royale-combat',
	'wuthering-waves-extract-fight',
	'wuthering-waves-cheats-aimbot',
	'wuthering-waves-cheats-cover',
	'wuthering-waves-cheats-esp-wallhack',
	'wuthering-waves-cheats-hero',
	'wuthering-waves-cheats-logo',
	'wuthering-waves-cheats-package',
	'wuthering-waves-header-art',
	'wuthering-waves-loadout-builder',
	'wuthering-waves-player-esp',
	'wuthering-waves-scav-run-combat',
	'wuthering-waves-scav-run-mode',
	'wuthering-waves-squad-fight',
	'wuthering-waves-verdansk-map',
];

async function removeOldWuthering WavesImages() {
...
async function generateResponsiveVariants() {
	const heroSource = path.join(imagesDir, 'wuthering-waves-esp-player-tags.webp');
	const heroMeta = await sharp(heroSource).metadata();

	for (const width of HERO_WIDTHS) {
		if (heroMeta.width && width > heroMeta.width) continue;
		const file = `wuthering-waves-esp-player-tags-${width}w.webp`;
	...
	for (const { file } of USER_SCREENSHOTS) {
		if (file === 'wuthering-waves-esp-player-tags.webp') continue;
...
async function generateFavicons() {
	const logoPath = path.join(imagesDir, 'wuthering-waves-cheats-logo.png');
...
await removeOldWuthering WavesImages();
