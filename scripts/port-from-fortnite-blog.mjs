#!/usr/bin/env node
/**
 * Ports the 8 posts from ../wuthering-waves-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'wuthering-waves-blog', 'src', 'content', 'posts');
...
for (const file of POST_FILES) {
	...
	sources.push({
		...
		intro: post.excerpt,
		keywords: [...post.tags, 'wuthering-waves intel'],
...
const file = `/* Auto-generated by scripts/port-from-wuthering-waves-blog.mjs — do not edit by hand. */
