/**
 * SVG overlay generators for Wuthering Waves cheats marketing images.
 * Composited on top of IGN Wuthering Waves gameplay screenshots.
 */
...
export function buildOverlaySvg(width, height, preset) {
	...
	switch (preset) {
		...
		case 'loot':
			...
			body += espBox(width * 0.68, height * 0.52, width * 0.06, height * 0.08, 'distance readout · 103m', '#fbbf24');
