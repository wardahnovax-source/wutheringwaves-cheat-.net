	...
	const categories = [
		{
			...
			links: [
				...
				{ href: '/wuthering-waves-esp/', labelKey: 'homeSeo.linkEsp' },
				{ href: '/wuthering-waves-aimbot/', labelKey: 'homeSeo.linkAimbot' },
				{ href: '/wuthering-waves-teleport/', labelKey: 'homeSeo.linkRadar' },
			],
		},
		{
			...
			links: [
				...
				{ href: '/wuthering-waves-cheats/', labelKey: 'homeSeo.linkUndetected' },
		...
		},
		{
			...
			links: [
				...
				{ href: '/wuthering-waves-cheats/', labelKey: 'homeSeo.linkWuthering WavesCheats' },
				{ href: '/features/', labelKey: 'homeSeo.linkAllFeatures' },
			],
		},
		{
