...
const imageMap: Record<BlogImageKey, string> = {
	hero: wutheringWavesImages.espWallhack,
	espWallhack: wutheringWavesImages.espWallhack,
	aimbotCombat: wutheringWavesImages.aimbotCombat,
	aimbotSkeleton: wutheringWavesImages.aimbotSkeleton,
	squadFight: wutheringWavesImages.aimbotCombat,
	headerArt: wutheringWavesImages.playerEsp,
	cheatsPackage: wutheringWavesImages.espWallhack,
	playerEsp: wutheringWavesImages.playerEsp,
	rebootFight: wutheringWavesImages.aimbotCombat,
	battleRoyaleCombat: wutheringWavesImages.cheatsCombat,
	battleRoyaleIslandMap: wutheringWavesImages.espWallhack,
};

const FALLBACK_BLOG_IMAGE = wutheringWavesImages.espWallhack;
...
export function getBlogSitemapEntriesForLocale(locale: LocaleCode) {
	...
	for (const post of blogPosts) {
		...
		const isProductPost = /Wuthering Waves Cheat|Aimbot|ESP|Undetected|Comparisons/i.test(post.category);
		entries.push({
