...
const defaultImages: BrandSitemapImage[] = [
	{
		src: '/images/wuthering-waves-cheats-esp.webp',
		title: 'wuthering waves cheats esp',
		caption: 'wuthering waves cheats esp wallhack',
	},
	{
		src: '/images/wuthering-waves-cheats-wallhack.webp',
		title: 'wuthering waves cheats wallhack',
		caption: 'wuthering waves cheats wallhack esp',
	},
	{
		src: '/images/wuthering-waves-cheats-aimbot.webp',
		title: 'wuthering waves cheats aimbot',
		caption: 'wuthering waves cheats aimbot soft aim',
	},
	{
		src: '/images/wuthering-waves-cheats-aimbot-view.webp',
		title: 'wuthering waves cheats aimbot',
		caption: 'wuthering waves cheats aimbot view',
	},
	{
		src: '/images/wuthering-waves-cheats-radar.webp',
		title: 'wuthering waves cheats radar',
		caption: 'wuthering waves cheats radar hack',
	},
	{
		src: '/images/wuthering-waves-cheats-raid.webp',
		title: 'wuthering waves cheats',
		caption: 'wuthering waves cheats in raid',
	},
];
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} hero — ESP and aimbot in Wuthering Waves', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'wuthering-waves-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'wuthering-waves-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and soft aim controls in {primaryKeyword}' },
	...
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for Wuthering Waves on PC' },
