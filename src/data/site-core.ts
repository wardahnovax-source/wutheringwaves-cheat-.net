...
export const productInfo = {
	...
	features: {
		esp: [
			'Enemy ESP with distance and name tags',
			'Echo & loot ESP markers',
			'Chest ESP and item highlights',
			'Custom ESP builder with filters',
			'Adjustable distance readouts',
			'Toggleable ESP categories',
		],
		aimbot: [
			'Aimbot with smoothness and FOV settings',
			'Enemy aimbot with bone priority',
			'Hotkeys during combat',
			'Per-weapon aim profiles',
			'Custom aimbot configuration',
		],
		radar: ['Teleportation to map locations', 'God mode and noclip', 'No fall damage'],
		general: [
			'Auto loot and magnetizer',
			'Free camera and FOV changer',
			'FPS unlocker for PC',
